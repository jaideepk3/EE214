...
-- Equation(s):
-- \add_instance|fa2|x1|Y~combout\ = \add_instance|xor2|Y~combout\ $ (\input_vector~combout\(6) $ (((\add_instance|fa1|a1|Y~combout\) # (\add_instance|fa1|ha|C~combout\))))
...
-- Equation(s):
-- \add_instance|fa2|o1|Y~0_combout\ = (\add_instance|xor2|Y~combout\ & ((\add_instance|fa1|a1|Y~combout\) # ((\input_vector~combout\(6)) # (\add_instance|fa1|ha|C~combout\)))) # (!\add_instance|xor2|Y~combout\ & (\input_vector~combout\(6) & 
