...
\add_instance|OR2|Y~0\ : maxv_lcell
-- Equation(s):
-- \add_instance|OR2|Y~0_combout\ = ((\input_vector~combout\(2) & ((\input_vector~combout\(0)) # (\input_vector~combout\(1)))) # (!\input_vector~combout\(2) & (\input_vector~combout\(0) & \input_vector~combout\(1))))
...
-- Equation(s):
-- \add_instance|OR1|Y~0_combout\ = (\input_vector~combout\(2) $ (\input_vector~combout\(0) $ (\input_vector~combout\(1))))
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|OR2|Y~0_combout\,
	oe => VCC,
