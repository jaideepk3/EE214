...
SIGNAL \dut_instance|add_instance|Equal3~0\ : std_logic;
SIGNAL \dut_instance|add_instance|Equal2~0\ : std_logic;
SIGNAL \dut_instance|add_instance|Equal3~1\ : std_logic;
...
SIGNAL \dut_instance|add_instance|y_present~7\ : std_logic;
...
-- Equation(s):
-- \shift_reg~3_combout\ = ((\io~regout\ & (!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & \u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_cdr~0_combout\)))
...
-- Equation(s):
-- \shift_reg~2_combout\ = (((\shift_reg~1_combout\ & !\io~regout\)))
...
-- Equation(s):
-- \dut_instance|add_instance|outp~0\ = (\dut_instance|add_instance|y_present.s4~regout\ & (\dut_instance|add_instance|Equal2~0\ & (!dut_input[6] & !dut_input(3))))
-- dut_input(6) = DFFEAS(\dut_instance|add_instance|outp~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	datab => \dut_instance|add_instance|Equal2~0\,
	datac => data(6),
	datad => dut_input(3),
	aclr => GND,
	sload => VCC,
...
-- Equation(s):
-- \dut_instance|add_instance|Equal3~0\ = (!dut_input(6) & (((dut_input[2]))))
-- dut_input(2) = DFFEAS(\dut_instance|add_instance|Equal3~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|Equal3~0\,
	regout => dut_input(2));

-- Location: LC_X5_Y4_N2
\dut_input[4]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|Equal2~0\ = (!dut_input(2) & (((dut_input[4] & !dut_input(5)))))
-- dut_input(4) = DFFEAS(\dut_instance|add_instance|Equal2~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|Equal2~0\,
	regout => dut_input(4));

-- Location: LC_X5_Y4_N9
\dut_input[5]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|Equal3~1\ = (!dut_input(3) & (!dut_input(4) & (dut_input[5] & \dut_instance|add_instance|Equal3~0\)))
-- dut_input(5) = DFFEAS(\dut_instance|add_instance|Equal3~1\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	datab => dut_input(4),
	datac => data(5),
	datad => \dut_instance|add_instance|Equal3~0\,
	aclr => GND,
	sload => VCC,
	ena => \shift_reg~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|Equal3~1\,
	regout => dut_input(5));

-- Location: LC_X6_Y5_N8
\dut_input[3]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|y_present~7\ = (\dut_instance|add_instance|y_present.s4~regout\ & (((dut_input[3]) # (dut_input(6))) # (!\dut_instance|add_instance|Equal2~0\)))
-- dut_input(3) = DFFEAS(\dut_instance|add_instance|y_present~7\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|y_present~7\,
	regout => dut_input(3));
...
\dut_instance|add_instance|Equal1~0\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|Equal1~0_combout\ = (dut_input(4) & (dut_input(5) & (dut_input(3) & \dut_instance|add_instance|Equal3~0\)))
...
\dut_instance|add_instance|y_present~11\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|y_present~11_combout\ = (\dut_instance|add_instance|y_present.s2~regout\ & (((!dut_input(6)) # (!\dut_instance|add_instance|Equal2~0\)) # (!dut_input(3))))
...
PORT MAP (
	dataa => dut_input(3),
	datab => \dut_instance|add_instance|Equal2~0\,
	datac => \dut_instance|add_instance|y_present.s2~regout\,
	datad => dut_input(6),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|add_instance|Equal0~0_combout\ = (!dut_input(4) & (!dut_input(5) & (dut_input(3) & \dut_instance|add_instance|Equal3~0\)))
...
\dut_instance|add_instance|y_present~13\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|y_present~13_combout\ = ((!\dut_instance|add_instance|Equal1~0_combout\ & ((\dut_instance|add_instance|y_present.s1~regout\))))
...
-- Equation(s):
-- \dut_instance|add_instance|y_present.s1~regout\ = DFFEAS((!dut_input(1) & ((\dut_instance|add_instance|y_present~13_combout\) # ((\dut_instance|add_instance|Equal0~0_combout\ & !\dut_instance|add_instance|y_present.rst~regout\)))), GLOBAL(dut_input(0)), 
-- VCC, , , , , , )
...
-- Equation(s):
-- \dut_instance|add_instance|y_present.s2~regout\ = DFFEAS((!dut_input(1) & ((\dut_instance|add_instance|y_present~11_combout\) # ((\dut_instance|add_instance|Equal1~0_combout\ & \dut_instance|add_instance|y_present.s1~regout\)))), GLOBAL(dut_input(0)), 
-- VCC, , , , , , )
...
PORT MAP (
	...
	dataa => dut_input(1),
	datab => \dut_instance|add_instance|Equal1~0_combout\,
	datac => \dut_instance|add_instance|y_present~11_combout\,
	datad => \dut_instance|add_instance|y_present.s1~regout\,
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\dut_instance|add_instance|y_present~9\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|y_present~9_combout\ = (dut_input(3) & (\dut_instance|add_instance|Equal2~0\ & (\dut_instance|add_instance|y_present.s2~regout\ & dut_input(6))))
...
-- Equation(s):
-- \dut_instance|add_instance|y_present.s3~regout\ = DFFEAS((!dut_input(1) & ((\dut_instance|add_instance|y_present~9_combout\) # ((\dut_instance|add_instance|y_present.s3~regout\ & !\dut_instance|add_instance|Equal3~1\)))), GLOBAL(dut_input(0)), VCC, , , , 
-- , , )
...
PORT MAP (
	clk => dut_input(0),
	dataa => \dut_instance|add_instance|y_present~9_combout\,
	datab => \dut_instance|add_instance|y_present.s3~regout\,
	datac => \dut_instance|add_instance|Equal3~1\,
	datad => dut_input(1),
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|add_instance|y_present.s4~regout\ = DFFEAS((!dut_input(1) & ((\dut_instance|add_instance|y_present~7\) # ((\dut_instance|add_instance|Equal3~1\ & \dut_instance|add_instance|y_present.s3~regout\)))), GLOBAL(dut_input(0)), VCC, , , , , , )
...
PORT MAP (
	clk => dut_input(0),
	dataa => \dut_instance|add_instance|Equal3~1\,
	datab => \dut_instance|add_instance|y_present.s3~regout\,
	datac => dut_input(1),
	datad => \dut_instance|add_instance|y_present~7\,
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \datau[0]~0_combout\ = (\shift_reg~3_combout\ & (\dut_instance|add_instance|y_present.s4~regout\)) # (!\shift_reg~3_combout\ & (((!\io~regout\) # (!\shift_reg~1_combout\))))
...
-- Equation(s):
-- \dut_instance|add_instance|Equal4~0_combout\ = (!dut_input(6) & (((!dut_input(3) & \dut_instance|add_instance|Equal2~0\))))
...
PORT MAP (
	dataa => dut_input(6),
	datac => dut_input(3),
	datad => \dut_instance|add_instance|Equal2~0\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\datau[0]\ : maxv_lcell
-- Equation(s):
-- datau(0) = DFFEAS((\datau[0]~0_combout\ & ((\shift_reg~3_combout\ & (\dut_instance|add_instance|Equal4~0_combout\)) # (!\shift_reg~3_combout\ & ((datau(0)))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , , , , )
