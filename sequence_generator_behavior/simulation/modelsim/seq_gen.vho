...
\datau[2]\ : maxv_lcell
-- Equation(s):
-- datau(2) = DFFEAS((\shift_reg~2_combout\ & (((\dut_instance|add_instance|state\(2))))) # (!\shift_reg~2_combout\ & (datau(2) & (!\shift_reg~3_combout\))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , , , , )
...
-- Equation(s):
-- \dut_instance|add_instance|state\(0) = DFFEAS(((\dut_instance|add_instance|state\(2) & ((!\dut_instance|add_instance|state\(1)))) # (!\dut_instance|add_instance|state\(2) & (\dut_instance|add_instance|state\(0)))), GLOBAL(dut_input(0)), !dut_input(1), , , 
-- , , , )
...
-- Equation(s):
-- \dut_instance|add_instance|state\(1) = DFFEAS(((\dut_instance|add_instance|state\(2) & (\dut_instance|add_instance|state\(0))) # (!\dut_instance|add_instance|state\(2) & ((!\dut_instance|add_instance|state\(1))))), GLOBAL(dut_input(0)), !dut_input(1), , , 
-- , , , )
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	datab => datau(2),
	datac => \dut_instance|add_instance|state\(1),
...
-- pragma translate_on
PORT MAP (
	datain => \dut_instance|add_instance|state\(2),
	oe => VCC,
