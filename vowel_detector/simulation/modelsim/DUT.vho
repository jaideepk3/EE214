...
SIGNAL \add_instance|and2|ALT_INV_Y~combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\add_instance|and2|ALT_INV_Y~combout\ <= NOT \add_instance|and2|Y~combout\;
...
\add_instance|and2|Y\ : maxv_lcell
-- Equation(s):
-- \add_instance|and2|Y~combout\ = (\input_vector~combout\(0)) # (\input_vector~combout\(1) $ (((\input_vector~combout\(3) & \input_vector~combout\(2)))))
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|and2|ALT_INV_Y~combout\,
	oe => VCC,
