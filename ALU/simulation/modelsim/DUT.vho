...
SIGNAL \dut_instance|add_instance|op~1\ : std_logic;
SIGNAL \dut_instance|add_instance|op[4]~2_combout\ : std_logic;
...
-- Equation(s):
-- \dut_instance|add_instance|Equal0~0\ = (((dut_input[9]) # (dut_input(8))))
...
-- Equation(s):
-- \dut_instance|add_instance|op~1\ = (dut_input(4) & (!dut_input(0) & (dut_input(9) $ (dut_input[8])))) # (!dut_input(4) & (dut_input(0) & (dut_input(9) $ (dut_input[8]))))
-- dut_input(8) = DFFEAS(\dut_instance|add_instance|op~1\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|op~1\,
	regout => dut_input(8));

-- Location: LC_X6_Y5_N2
\dut_instance|add_instance|op[4]~2\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|op[4]~2_combout\ = (!dut_input(9) & (((dut_input(4)))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|op[4]~2_combout\);
...
\datau[6]\ : maxv_lcell
-- Equation(s):
-- datau(6) = DFFEAS((\shift_reg~3_combout\ & (((datau(7))))) # (!\shift_reg~3_combout\ & (!\dut_instance|add_instance|Equal0~0\ & ((dut_input(6))))), 
...
\datau[5]\ : maxv_lcell
-- Equation(s):
-- datau(5) = DFFEAS((\shift_reg~3_combout\ & (datau(6))) # (!\shift_reg~3_combout\ & (((dut_input(5) & !\dut_instance|add_instance|Equal0~0\)))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[1]~4_combout\, , , , )
...
-- Equation(s):
-- \dut_instance|add_instance|op[4]~3_combout\ = ((dut_input(9) & ((dut_input(7)))) # (!dut_input(9) & (\dut_instance|add_instance|carry~3_combout\)))
...
\datau[4]\ : maxv_lcell
-- Equation(s):
-- datau(4) = DFFEAS((dut_input(8) & (((\dut_instance|add_instance|op[4]~3_combout\)))) # (!dut_input(8) & (\dut_instance|add_instance|op[4]~2_combout\)), 
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => dut_input(8),
	datab => \dut_instance|add_instance|op[4]~2_combout\,
	datac => \datau[4]~12_combout\,
	datad => \dut_instance|add_instance|op[4]~3_combout\,
	aclr => GND,
...
\datau[0]\ : maxv_lcell
-- Equation(s):
-- datau(0) = DFFEAS((\dut_instance|add_instance|Equal0~0\ & (\dut_instance|add_instance|op~1\)) # (!\dut_instance|add_instance|Equal0~0\ & (((dut_input(0))))), 
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|add_instance|Equal0~0\,
	datab => \dut_instance|add_instance|op~1\,
