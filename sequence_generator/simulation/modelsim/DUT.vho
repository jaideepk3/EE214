...
\datau[2]\ : maxv_lcell
-- Equation(s):
-- datau(2) = DFFEAS((\shift_reg~2_combout\ & (((\dut_instance|add_instance|dff_0|Q~regout\)))) # (!\shift_reg~2_combout\ & (!\shift_reg~3_combout\ & (datau(2)))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , , , , )
...
-- Equation(s):
-- \dut_instance|add_instance|dff_2|Q~regout\ = DFFEAS(((\dut_instance|add_instance|dff_0|Q~regout\ & ((!\dut_instance|add_instance|dff_1|Q~regout\))) # (!\dut_instance|add_instance|dff_0|Q~regout\ & (\dut_instance|add_instance|dff_2|Q~regout\))), 
...
-- Equation(s):
-- \dut_instance|add_instance|dff_1|Q~regout\ = DFFEAS(((\dut_instance|add_instance|dff_0|Q~regout\ & (\dut_instance|add_instance|dff_2|Q~regout\)) # (!\dut_instance|add_instance|dff_0|Q~regout\ & ((!\dut_instance|add_instance|dff_1|Q~regout\)))), 
-- GLOBAL(dut_input(0)), !dut_input(1), , , , , , )
...
\datau[0]\ : maxv_lcell
-- Equation(s):
-- datau(0) = DFFEAS((\shift_reg~2_combout\ & (((\dut_instance|add_instance|dff_2|Q~regout\)))) # (!\shift_reg~2_combout\ & (((datau(1))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[0]~1_combout\, , , , )
...
-- Equation(s):
-- \dut_instance|add_instance|dff_0|Q~regout\ = DFFEAS(\dut_instance|add_instance|dff_2|Q~regout\ $ (((\dut_instance|add_instance|dff_0|Q~regout\ $ (\dut_instance|add_instance|dff_1|Q~regout\)))), GLOBAL(dut_input(0)), !dut_input(1), , , , , , )
