...
-- Equation(s):
-- \dut_instance|add_instance|state\(2) = DFFEAS(((\dut_instance|add_instance|state\(2) $ (\dut_instance|add_instance|state\(1)))), GLOBAL(dut_input(0)), !dut_input(1), , , , , , )
...
\datau[3]\ : maxv_lcell
-- Equation(s):
-- datau(3) = DFFEAS((\shift_reg~3_combout\ & (\dut_instance|add_instance|state\(3))) # (!\shift_reg~3_combout\ & (((!\shift_reg~2_combout\ & datau(3))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , , , , )
...
PORT MAP (
	...
	datab => \dut_instance|add_instance|state\(3),
...
\datau[2]\ : maxv_lcell
-- Equation(s):
-- datau(2) = DFFEAS(((\shift_reg~3_combout\ & (\dut_instance|add_instance|state\(2))) # (!\shift_reg~3_combout\ & ((datau(3))))), 
...
\datau[1]\ : maxv_lcell
-- Equation(s):
-- datau(1) = DFFEAS(((\shift_reg~3_combout\ & (\dut_instance|add_instance|state\(1))) # (!\shift_reg~3_combout\ & ((datau(2))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[1]~2_combout\, , , , )
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	datab => \dut_instance|add_instance|state\(1),
	datac => datau(2),
...
PORT MAP (
	clk => dut_input(0),
	dataa => \dut_instance|add_instance|state\(3),
	datab => \dut_instance|add_instance|state\(1),
	datac => \dut_instance|add_instance|state\(2),
	aclr => dut_input(1),
	devclrn => ww_devclrn,
